    ...
    async function Category() {
      try {
        const response = await fetch(
          `http://127.0.0.1:8000/category/${param.category}`
        );
        if (!response.ok) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {data.map((data) => (
              <div class="bg-white shadow-md rounded-lg max-w-sm max-h-sm dark:bg-gray-800 dark:border-gray-700 w-full">
